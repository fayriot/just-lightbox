...
import { LightboxComponent } from '../lib/components/lightbox/lightbox.component';
...
@Component({
    template: `
        <img
            ...
            jLightbox="https://placehold.co/400"
        />
...
describe('Just Lightbox', () => {
    ...
    it('should open from image', () => {
        ...
        const target =
            fixtureTest.debugElement.nativeElement.querySelector('.image');
        target.click();
    ...
    it('should open from anchor', () => {
        const fixtureTest = TestBed.createComponent(LightboxTestComponent);
        const target =
            fixtureTest.debugElement.nativeElement.querySelector('.anchor');
        target.click();
        fixtureTest.detectChanges();
        expect(el.querySelector(DEFAULT_LIGHTBOX_IMAGE_SELECTOR)).toBeTruthy();
    });
